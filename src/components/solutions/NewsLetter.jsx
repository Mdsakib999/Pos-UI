    ...
    <div className="bg-[#FFEDE6] flex flex-col justify-center items-center mt-20 px-4 py-10 space-y-5">
      ...
      <div className="w-full max-w-md space-y-3">
        <div className="relative w-full">
          ...
          />
          <input
            className="w-full text-gray-800 bg-white rounded-md py-2.5 pl-12 pr-5 placeholder:font-serif focus:border-2 focus:border-orange-600 outline-none"
            placeholder="Enter your email"
          />
        </div>
        <button className="cursor-pointer w-full border rounded-md bg-black text-white py-2.5 font-serif hover:bg-white hover:text-black transition duration-300">
          Submit
        </button>
      </div>
    </div>
